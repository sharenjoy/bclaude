---
name: session-todo
description: 工作 session 任務管理系統。當使用者說「開工」、「收工」、「今天要做什麼」、「列出任務」、「任務清單」、「我要開始工作」、「工作結束」、「start work」、「end work」、「session-todo」、「目前進度」、「現在要做什麼」、「顯示 todo」時觸發。在 todo/ 目錄下為每次 session 建立獨立 md 檔（以日期時間命名），以 session（每次開工/收工）為單位追蹤任務，保有完整歷史，支援 PRD 參照討論後續任務。
---
